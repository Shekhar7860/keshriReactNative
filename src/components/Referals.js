...
searchProfiles = () => {
   ...
   service.searchMatrimonial('5F', '6F', '21 Yrs', '24 Yrs', 'Any', 'Bride').then((res) => {
            alert(Json.stringify(res), 'resssssss')
      ...
      <View style={{flex:1}}>
        <Spinner visible={this.state.visible} color='#ff3f34' tintColor='#ff3f34' animation={'fade'} cancelable={false} textStyle={{ color: '#FFF' }} />
         ...
         <TouchableOpacity onPress={() => this.goBack()}>
                    ...
                    <Text style={{...styles.toolbarTitle, textAlign:'center'}}>Matrimonials (वैवाहिक)</Text>
                    <TouchableOpacity>
